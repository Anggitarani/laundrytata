    <?php    
 $transaksi=mysqli_query($koneksi,"SELECT * FROM tb_transaksi INNER JOIN tb_user ON tb_transaksi.id_user=tb_user.id_user JOIN tb_customer ON tb_transaksi.id_cust=tb_customer.id_cust WHERE tb_transaksi.dibayar='belum_dibayar'");
 if (isset($_POST['add'])) {
